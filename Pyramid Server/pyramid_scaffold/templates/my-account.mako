...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<input type="hidden" id="woocommerce-lost-password-nonce" name="woocommerce-lost-password-nonce" value="c0d79fda0f" /><input type="hidden" name="_wp_http_referer" value="/wordpress/WP01/WP008/my-account/lost-password/" />
</form>
</div>
</div><!-- .entry-content -->
	</div>
...
</p></div><label style="display: none !important;">Leave this field empty if you're human: <input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></label><input type="hidden" name="_mc4wp_timestamp" value="1681734485" /><input type="hidden" name="_mc4wp_form_id" value="12228" /><input type="hidden" name="_mc4wp_form_element_id" value="mc4wp-form-1" /><div class="mc4wp-response"></div></form><!-- / Mailchimp for WordPress Plugin --></div>	</div>
</div><!-- .footer-widget4 -->
					</div>
								</div>
		</div>
...
<ul class="sub-menu">
	...
	<ul class="sub-menu">
		<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-13 current_page_item menu-item-11475"><a href="./my-account" aria-current="page">My account</a></li>
